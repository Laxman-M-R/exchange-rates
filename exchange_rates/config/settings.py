...
APP_ID = env.str("APP_ID", default="name")
BASE_URL = env.str("BASE_URL", default="name")
...
SECRET_KEY = 'django-insecure-co3id=21x%^r@j=pbi2h51e(ldzvxz(&)$n=lh-0nqoamj3fq='
